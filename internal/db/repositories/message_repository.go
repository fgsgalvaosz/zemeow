...
// MessageRepository interface define os métodos para operações com mensagens
...
// messageRepository implementa MessageRepository
type messageRepository struct {
	db     *sqlx.DB
	logger logger.Logger
}

// NewMessageRepository cria uma nova instância do MessageRepository
...
// List busca mensagens com filtros
...
// ListByChat busca mensagens de um chat específico
...
// Search busca mensagens por texto
...
// GetStatistics retorna estatísticas de mensagens para uma sessão
...
// GetChatStatistics retorna estatísticas de mensagens para um chat específico
func (r *messageRepository) GetChatStatistics(sessionID uuid.UUID, chatJID string) (*models.MessageStatistics, error) {
	...
	// Outras estatísticas específicas do chat
	err = r.db.Get(&stats.UnreadMessages, `
		SELECT COUNT(*) FROM messages
...
// GetUnreadCount retorna o número de mensagens não lidas
...
// CleanupEphemeralMessages remove mensagens efêmeras antigas
...
// GetReplies retorna as respostas a uma mensagem específica
...
// GetReactions retorna as reações a uma mensagem específica
